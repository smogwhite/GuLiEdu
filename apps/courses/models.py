...
from orgs.models import OrgInfo, TeacherIngo
...
class CourseInfo(models.Model):
    ...
    orginfo = models.ForeignKey(OrgInfo, verbose_name="老师教导")
    teacherinfo = models.ForeignKey(TeacherIngo, verbose_name="所属讲师")
